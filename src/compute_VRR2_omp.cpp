...
#define FM_N_VEC 4
#define FM_N_SCA 5
constexpr int Fsize_but_constexpr( int L ){ return L + 1 + FM_N_VEC * 3 + FM_N_SCA; }
#undef FM_N_VEC
#undef FM_N_SCA



//constexpr int SA ( int L ) {
...
void execute_VRR1_gpu( // int AL, int CL, int m, 
   ...
   int my_vrr_rank = omp_get_thread_num() % VTS;
//   int my_vrr_rank = 0; // threadIdx.x % VTS ;
...
template< int VTS >
void ssss(double * ss0 , double para[4*3+5] ){
}

template< int VTS >
void sssp(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double*  sp0  = ss0 + 2 ;
...
template< int VTS >
void sssd(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 3 ;
   double*  sd0  = ss0 + 9 ;
...
template< int VTS >
void sssf(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 4 ;
   double*  sd0  = ss0 + 13 ;
...
template< int VTS >
void ssps(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double*  sp0  = ss0 + 2 ;
   execute_VRR1_gpu< VTS, 1, 0, 1 >( sp0 , ss0 , QC_WQ);
}
...
template< int VTS >
void sspp(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 3 ;
   double*  sd0  = ss0 + 9 ;
...
template< int VTS >
void sspd(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 4 ;
   double*  sd0  = ss0 + 13 ;
...
template< int VTS >
void sspf(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 5 ;
   double*  sd0  = ss0 + 17 ;
...
template< int VTS >
void ssds(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 3 ;
   double*  sd0  = ss0 + 9 ;
...
template< int VTS >
void ssdp(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 4 ;
   double*  sd0  = ss0 + 13 ;
...
template< int VTS >
void ssdd(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 5 ;
   double*  sd0  = ss0 + 17 ;
...
template< int VTS >
void ssdf(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 6 ;
   double*  sd0  = ss0 + 21 ;
...
template< int VTS >
void ssfs(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 4 ;
   double*  sd0  = ss0 + 13 ;
...
template< int VTS >
void ssfp(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 5 ;
   double*  sd0  = ss0 + 17 ;
...
template< int VTS >
void ssfd(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 6 ;
   double*  sd0  = ss0 + 21 ;
...
template< int VTS >
void ssff(double * ss0 , double para[4*3+5] ){
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double*  sp0  = ss0 + 7 ;
   double*  sd0  = ss0 + 25 ;
...
template< int VTS >
void spss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double*  ps0  = ss0 + 2 ;
...
template< int VTS >
void spsp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double   z     = para[16];
   double*  ss1  = ss0 + 1 ;
...
template< int VTS >
void spsd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void spsf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void spps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double   z     = para[16];
   double*  ss1  = ss0 + 1 ;
...
template< int VTS >
void sppp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void sppd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void sppf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void spds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void spdp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void spdd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void spdf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void spfs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void spfp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void spfd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void spff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void sdss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 3 ;
   double*  ds0  = ss0 + 9 ;
...
template< int VTS >
void sdsp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void sdsd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sdsf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sdps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void sdpp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sdpd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sdpf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sdds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sddp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sddd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sddf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sdfs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sdfp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sdfd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sdff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sfss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 4 ;
   double*  ds0  = ss0 + 13 ;
...
template< int VTS >
void sfsp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void sfsd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sfsf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sfps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void sfpp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sfpd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sfpf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sfds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sfdp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sfdd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sfdf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sffs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sffp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sffd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void sfff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void psss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double*  ps0  = ss0 + 2 ;
   execute_VRR1_gpu< VTS, 1, 0, 1 >( ps0 , ss0 , PA_WP);
}
...
template< int VTS >
void pssp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double   z     = para[16];
   double*  ss1  = ss0 + 1 ;
...
template< int VTS >
void pssd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void pssf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void psps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double   z     = para[16];
   double*  ss1  = ss0 + 1 ;
...
template< int VTS >
void pspp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void pspd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void pspf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void psds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void psdp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void psdd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void psdf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void psfs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void psfp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void psfd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void psff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zcd   = para + 14;
   double   z     = para[16];
...
template< int VTS >
void ppss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 3 ;
   double*  ds0  = ss0 + 9 ;
...
template< int VTS >
void ppsp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void ppsd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ppsf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ppps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void pppp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pppd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pppf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ppds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ppdp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ppdd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ppdf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ppfs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ppfp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ppfd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ppff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pdss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 4 ;
   double*  ds0  = ss0 + 13 ;
...
template< int VTS >
void pdsp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void pdsd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pdsf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pdps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void pdpp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pdpd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pdpf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pdds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pddp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pddd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pddf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pdfs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pdfp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pdfd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pdff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pfss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 5 ;
   double*  ds0  = ss0 + 17 ;
...
template< int VTS >
void pfsp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void pfsd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pfsf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pfps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void pfpp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pfpd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pfpf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pfds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pfdp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pfdd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pfdf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pffs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pffp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pffd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void pfff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dsss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 3 ;
   double*  ds0  = ss0 + 9 ;
...
template< int VTS >
void dssp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void dssd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dssf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dsps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void dspp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dspd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dspf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dsds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dsdp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dsdd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dsdf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dsfs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dsfp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dsfd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dsff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dpss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 4 ;
   double*  ds0  = ss0 + 13 ;
...
template< int VTS >
void dpsp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void dpsd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dpsf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dpps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void dppp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dppd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dppf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dpds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dpdp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dpdd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dpdf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dpfs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dpfp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dpfd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dpff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ddss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 5 ;
   double*  ds0  = ss0 + 17 ;
...
template< int VTS >
void ddsp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void ddsd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ddsf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ddps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void ddpp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ddpd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ddpf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ddds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dddp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dddd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dddf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ddfs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ddfp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ddfd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ddff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dfss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 6 ;
   double*  ds0  = ss0 + 21 ;
...
template< int VTS >
void dfsp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void dfsd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dfsf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dfps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void dfpp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dfpd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dfpf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dfds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dfdp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dfdd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dfdf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dffs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dffp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dffd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void dfff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fsss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 4 ;
   double*  ds0  = ss0 + 13 ;
...
template< int VTS >
void fssp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void fssd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fssf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fsps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void fspp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fspd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fspf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fsds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fsdp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fsdd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fsdf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fsfs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fsfp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fsfd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fsff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fpss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 5 ;
   double*  ds0  = ss0 + 17 ;
...
template< int VTS >
void fpsp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void fpsd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fpsf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fpps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void fppp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fppd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fppf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fpds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fpdp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fpdd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fpdf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fpfs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fpfp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fpfd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fpff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fdss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 6 ;
   double*  ds0  = ss0 + 21 ;
...
template< int VTS >
void fdsp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void fdsd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fdsf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fdps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void fdpp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fdpd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fdpf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fdds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fddp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fddd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fddf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fdfs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fdfp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fdfd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fdff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ffss(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * zab   = para + 12;
   double*  ps0  = ss0 + 7 ;
   double*  ds0  = ss0 + 25 ;
...
template< int VTS >
void ffsp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void ffsd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ffsf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ffps(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double   z     = para[16];
...
template< int VTS >
void ffpp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ffpd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ffpf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ffds(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ffdp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ffdd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ffdf(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fffs(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fffp(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void fffd(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template< int VTS >
void ffff(double * ss0 , double para[4*3+5] ){
   double * PA_WP = para;
   double * QC_WQ = para + 6;
   double * zab   = para + 12;
   double * zcd   = para + 14;
...
template < int VTS >
constexpr auto get_vrr_kernel(int Lindex ){
...
void compute_VRR_v3_batched_gpu_low(
      const int Ncells, 
...
//   int my_vrr_team = threadIdx.x / VTS ;
   ...
   for( int block=0; block < Ncells*Ng ; block ++ ){
      ...
      for ( unsigned i = 0; i < n_prm * VTS;  i ++ ){

         int my_vrr_team = omp_get_thread_num() / VTS;
         int my_vrr_rank = omp_get_thread_num() % VTS;
         int prm = i + my_vrr_team;
...
//         // Screening on the (ab.n1|cd.n2@n3) fondamental integrals
         ...
         while ( not found and prm < n_prm ){
            Of = ((Ov+prm) * Ng + n3 ) * F_size;
            // copy Fm[0] ( the ssss(0) integral ) to AC for later screening in ECO
            pr_mem = &AC[ ((Ov+prm) * Ng + n3) * vrr_blocksize ];
            pr_mem[0] = Fm[Of];
            // Immediate screening
...
// this type is actually a function, that takes that list 
...
#define F_LIST_1(i, j, k) \
    compute_VRR_v3_batched_gpu_low<4,16,i,j,k,0>, \
    compute_VRR_v3_batched_gpu_low<4,16,i,j,k,1>, \
    compute_VRR_v3_batched_gpu_low<4,16,i,j,k,2>, \
    compute_VRR_v3_batched_gpu_low<4,16,i,j,k,3>

#define F_LIST_2(i, j) \
    F_LIST_1(i, j, 0), F_LIST_1(i, j, 1), F_LIST_1(i, j, 2), F_LIST_1(i, j, 3)

#define F_LIST_3(i) \
    F_LIST_2(i, 0), F_LIST_2(i, 1), F_LIST_2(i, 2), F_LIST_2(i, 3)

#define F_LIST \
    F_LIST_3(0), F_LIST_3(1), F_LIST_3(2), F_LIST_3(3)

   vrr_global_t vrr[4*4*4*4] = { F_LIST };
#undef F_LIST
#undef F_LIST_3
#undef F_LIST_2
#undef F_LIST_1
...
void compute_VRR_v3_omp(
      ...
      double* const __restrict__ ABCD,
      int vrr_blocksize, int hrr_blocksize, int numV, int numVC, const int Ng ){
   get_vrr( vrr_index )( Ncells, PMX,FVH,Fm,data,AC,ABCD,vrr_blocksize,hrr_blocksize,numV,numVC,Ng );
}
